"""
Django settings for escala_project project.
...
SECRET_KEY = 'django-insecure-z$*&fm977zr*#yt1p@4_jg936#geodz&a^r6&i&!9@-ky(wt=k'
...
WSGI_APPLICATION = 'escala_project.wsgi.application'
...
DATABASES = {
    "default": {
        ...
        "NAME": "escala-db",
        "USER": "avnadmin",
        "PASSWORD": "AVNS_s6yYNK-6vc0Mg0hbCWD",
        "HOST": "escala-testing-escala-testing.c.aivencloud.com",
        "PORT": 23519,
    }
}
